...
const Transaction = () => {
    ...
    const [showMobileFilter, setShowMobileFilter] = useState(window.matchMedia("(max-width:530px)").matches);
        ...
        <section className='table_contain'>
            <div className='table-container'>
                <div className='flex items-center mb-[16px]'>
                    ...
                    {
                    showMobileFilter ? 
                        <button className="mobile-filter-table relative" onClick={() => setShowOption(!showOption)}>
                            ...
                            <div className="overflow-hidden shadow-md sm:rounded-lg">
                                <table className="min-w-full table">
                                    <thead className="table-head">
                                        <tr>
                                            <th scope="col" className="py-3 px-6 font-medium tracking-wider text-left uppercase dark:text-gray-400 table-head_item">
                                                <div className='flex items-center'>
                                                    id <ArrDown />
                                                </div>
                                            ...
                                            <th scope="col" className="py-3 px-6 font-medium tracking-wider text-left uppercase dark:text-gray-400 table-head_item w-[150px]">
                                                <div className='flex items-center'>
                                                    amount <ArrDown />
                                                </div> 
                                            </th>
