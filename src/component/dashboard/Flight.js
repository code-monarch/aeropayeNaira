...
import FlightsInfo from "../../pages/Flights/components/AllFlight";
import OngoingFlight from "../../pages/Flights/components/OngoingFlight";
...
import CheckInModal from "../../pages/Flights/components/CheckInModal";
import CancelModal from "../../pages/Flights/components/CancelModal";
import RefundModal from "../../pages/Flights/components/RefundModal";
import RefundedModal from "../../pages/Flights/components/RefundedModal";
      ...
      <div className="flight">
        <div className="flight-container">
          <div className="flex items-center flight-container-navs">
            ...
            <Link to="/passenger/book-flight" className="book-button">
              Book a flight
            </Link>
          </div>
