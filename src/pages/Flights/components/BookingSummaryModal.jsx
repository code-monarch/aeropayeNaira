...
const BookingSummaryModal = ({ openBookingSummary, onCloseBookingModal }) => {
  ...
  // Handles event when Enter key is pressed
    ...
    <>
      ...
      >
        <div className="modal_container w-[482px] rounded-[8px]">
          ...
          <div className="summary_body px-[24px] py-[16px]">
            <BookingSummary />
            <div></div>
            {/* Pay now Button */}
            <div
              ...
              initialFocusRef
              onClick={onShowBookingSuccess}
              className="bg-[#060A33] py-[15px] px-[16px] text-center mt-[16px] text-white font-medium lead-[19px] shadow-sm rounded-[6px] cursor-pointer"
            >
              Pay now 122.8070 Aeropaye
            </div>
            <div className=" text-center mt-[16px] text-black font-medium lead-[19px] cursor-pointer">
              I will pay later
            </div>
          </div>
