    ...
    <>
        ...
        <div className="withdraw-container">
            ...
            <div className='withdraw-form'>
                ...
                <Warning />
                <p className='ml-[10px]'>Send only <b>Aeropaye (TICKER)</b> to this address. Sending any other coins may result to permanent loss</p>
                    
                </div>

                    <div className='withdraw-form_amount-form'>
                        <p className='withdraw-form_amount-form_title'>Aeropaye Address</p>
